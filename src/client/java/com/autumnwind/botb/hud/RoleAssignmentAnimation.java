...
public class RoleAssignmentAnimation {
    ...
    private static String getAnimatingDisplayName() {
        ...
        return Component.translatable("gui.blood-on-the-blocktower.common.unknown_player").getString();
    }
    ...
    private static void renderTitle(GuiGraphicsExtractor drawContext, Minecraft client, long elapsed, int screenWidth, int screenHeight) {
        ...
        Component titleText = Component.literal(roleName);
        ...
        float scale = 3.0f;
        int textWidth = client.font.width(titleText);
