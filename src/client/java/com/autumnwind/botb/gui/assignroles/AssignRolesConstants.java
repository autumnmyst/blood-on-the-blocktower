...
public class AssignRolesConstants {
    ...
    public static final Identifier SHROUD_ICON = Identifier.of("blood-on-the-blocktower", "textures/icons/barrier.png");
    public static final Identifier DUSK_ICON = Identifier.of("blood-on-the-blocktower", "textures/icons/dusk.png");
    public static final Identifier DAWN_ICON = Identifier.of("blood-on-the-blocktower", "textures/icons/dawn.png");
